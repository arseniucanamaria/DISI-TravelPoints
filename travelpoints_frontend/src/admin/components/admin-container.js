...
import ObjectiveGraphic from '../components/graphics/objective-graphic';
import LocationGraphic from '../components/graphics/location-graphic';
import MonthGraphic from '../components/graphics/month-graphic';
import HourGraphic from '../components/graphics/hour-graphic';
     ...
     <>
        <Header />
         ...
         <div style={title}>
            ...
            <div style={divGraphic1}></div>
              <div style={divGraphic}>
                <h2 style={{textAlign:'center', fontFamily:'Courier New'}}> Graphics and Statistics</h2>
                <div style={{textAlign:'center', width: '50%', marginTop:'80px', marginLeft:'300px'}}>
                    <ObjectiveGraphic style={{textAlign:'center'}}/>
                </div>
                 <div style={{textAlign:'center', width: '50%', marginTop:'100px', marginLeft:'300px'}}>
                    <LocationGraphic style={{padding:'100px 40px 100px 40px', marginTop:'100px', marginBottom:'100px'}}/>
                </div>
                <div style={{textAlign:'center', width: '50%', marginTop:'100px', marginLeft:'300px'}}>
                    <MonthGraphic style={{padding:'100px 40px 100px 40px', marginTop:'100px', marginBottom:'100px'}}/>
                </div>
                <div style={{textAlign:'center', width: '50%', marginTop:'100px', marginLeft:'300px'}}>
                    <HourGraphic style={{padding:'100px 40px 100px 40px', marginTop:'100px', marginBottom:'100px'}}/>
                </div>
              </div>
        </>
    );
