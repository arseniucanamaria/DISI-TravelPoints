        ...
        return (
            <div>
                ...
                <FormGroup id='nume_obiectiv'>
                    ...
                    <Input name='nume_obiectiv' id='numeObiectivField' placeholder={this.state.formControls.nume_obiectiv.placeholder}
                ...
                <FormGroup id='locatie'>
                    ...
                    <Input name='locatie' id='locatieField' placeholder={this.state.formControls.locatie.placeholder}
                        onChange={this.handleChange}
                ...
                <Row>
                    <Col sm={{ size: '4', offset: 8 }}>
                        <Button type={"submit"}  onClick={this.handleSubmit}>  Add Objective </Button>
                    </Col>
                </Row>
